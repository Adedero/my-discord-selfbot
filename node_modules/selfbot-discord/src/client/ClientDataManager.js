...
class ClientDataManager {
  ...
  async newRelation(data) {
    if (data) {
      let user = this.client.users.has(data.id) ? this.client.users.get(data.id) : this.newUser(data.user);
      ...
      // if (!relation.user?.id) relation.user = await this.client.fetchUser(data.id).catch(console.error);
